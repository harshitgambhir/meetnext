      ...
      <div className='max-w-5xl mx-auto'>
        ...
        <div className='px-4'>
          <div className='flex flex-col mt-4'>
            <div className='text-3xl md:text-5xl text-center pt-10 font-bold leading-normal md:leading-normal'>Host paid 1-on-1 meeings<br />with people virtually</div>
          ...
          <div className='flex flex-col mt-10'>
            ...
            <div className='flex flex-col md:flex-row justify-between items-center md:items-start mt-16'>
              ...
              <div className='text-center  max-w-md md:w-1/3 p-4'>
                <div className='font-bold text-xl'>Set your availability</div>
                <p className='break-words  mt-2'>Take meetings as per your own schedule. Start by adding your availability date and time. You can edit your availability anytime you want.</p>
              </div>
              <div className='text-center  max-w-md md:w-1/3 p-4'>
